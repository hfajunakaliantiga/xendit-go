...
[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go)
![](https://github.com/hfajunakaliantiga/xendit-go/workflows/integration-test/badge.svg)
![](https://github.com/hfajunakaliantiga/xendit-go/workflows/lint/badge.svg)
[![Coverage Status](https://coveralls.io/repos/github/xendit/xendit-go/badge.svg)](https://coveralls.io/github/xendit/xendit-go)
[![Go Report Card](https://goreportcard.com/badge/github.com/hfajunakaliantiga/xendit-go)](https://goreportcard.com/report/github.com/hfajunakaliantiga/xendit-go)
...
For the details of this library, see the [GoDoc](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go).
...
```sh
go get -u github.com/hfajunakaliantiga/xendit-go
```
...
import (
    ...
    "github.com/hfajunakaliantiga/xendit-go/$product$"
)
```
...
require (
  github.com/hfajunakaliantiga/xendit-go v1.0.0
)
```
...
After installing [validator](https://github.com/go-playground/validator), [xendit-go](https://github.com/hfajunakaliantiga/xendit-go)
...
import (
    "github.com/hfajunakaliantiga/xendit-go"
    "github.com/hfajunakaliantiga/xendit-go/client"
)
...
The following is a list of pointers to documentations for sub-packages of [xendit-go](https://github.com/hfajunakaliantiga/xendit-go).

- [Invoice](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/invoice)
- [E-Wallet](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/ewallet)
- [Balance](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/balance)
- [Virtual Account](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/virtualaccount)
- [Retail Outlet](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/retailoutlet)
- [Disbursement](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/disbursement)
- [Card](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/card)
- [Payout](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/payout)
- [Recurring Payment](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/recurringpayment)
- [Cardless Credit](https://pkg.go.dev/github.com/hfajunakaliantiga/xendit-go/cardlesscredit)

## Contribute

For any requests, bugs, or comments, please [open an issue](https://github.com/hfajunakaliantiga/xendit-go/issues/new) or submit a pull request.
...
After the code passes everything, please [submit a pull request](https://github.com/hfajunakaliantiga/xendit-go/pulls).
